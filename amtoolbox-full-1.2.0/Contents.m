...
%   -------------------------------
%
%   Matlab 2017a (or more recent) or Octave 4.3 (limited support). Further, the large time-frequency analysis toolbox (*LTFAT*) is essential. It will be downloaded and installed by amt_start on the fly if not available on your system.
%
...
%
%
%   Url: http://amtoolbox.org/amt-1.2.0/doc/Contents.php
