...
/* This is Version 5 of the code for auditory periphery model of:
   ...
   with the modifications and simulation options described in:
    ...
    Zilany, M.S.A., Bruce, I.C., and Carney, L.H. (2014) "Updated parameters and 
        ...
        Journal of the Acoustical Society of America 135(1): 283-286.
    
    Zilany, M.S.A., Bruce, I.C., Ibrahim, R.A., and Carney, L.H. (2013) "Improved 
        parameters and expanded simulation options for a model of the auditory periphery," 
        ARO Midwinter Research Meeting, pp 440-441.
   ...
   The modifications to the BM tuning are described in:
        ...
        Ibrahim, R. A., and Bruce, I. C. (2010). "Effects of peripheral tuning on the auditory nerve's representation of speech envelope and temporal fine structure cues," in The Neurophysiological Bases of Auditory Perception, eds. E. A. Lopez-Poveda and A. R. Palmer and R. Meddis, Springer, NY, pp. 429-438.
